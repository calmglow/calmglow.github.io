...
function ap_validfile( ctrl, minimum, maximum )
{
	...
	if ( !static_isnothing(ctrl)) {
		...
		if ( fileidx < 0 )
			var fileidx = pathvalue.lastIndexOf("index.html");
...
function setndr()
{
	...
	if ( ( Ukey != null && Ukey != "" ) && ( Ctmpndr != null && Ctmpndr != "" )   )	{
		...
		setCookie("ndrn", Undr , null, "index.html", ".egloos.com", false);
		// Ctmpndr delete
		var del_expired_data = new Date(2001,1,1);
		setCookie("tmpndr", "" , del_expired_data, "index.html", ".egloos.com",false);
	}
}
// ndr cookie function
...
function ap_copyright()
{
	...
	if ( host == "www" ) {
		...
		if ( url.indexOf("/login") >= 0 ) {
			spcuri = "login/index.html";
		} else if ( url.indexOf("adm/index.html") >= 0 ) {
            spchost = "adm";
			spcuri = "";
			if ( url.indexOf("adm/photo/index.html") >= 0 ) {
                spcuri += "photo/index.html";
                if(url.indexOf("http://err.egloos.com/") >= 0) {
                    spcuri += "photolog/index.html";
                } else if(url.indexOf("http://err.egloos.com/") >= 0) {
                    spcuri += "album/index.html";
                } else if(url.indexOf("http://err.egloos.com/") >= 0) {
                    spcuri += "photolog_skin/index.html";
                }
            } else if ( url.indexOf("adm/stat/index.html") >= 0 ) {
                spcuri += "stat/index.html";
                if( url.indexOf("egloo_stat.html") >= 0 ) {
                    spcuri += "egloo_stat";
                } else if( url.indexOf("http://err.egloos.com/") >= 0) {
            ...
            } else if ( url.indexOf("adm/skin2/index.html") >= 0 ) {
                spcuri += "skin2/index.html";
                if(url.indexOf("http://err.egloos.com/") >= 0) {
                    spcuri += "myskin/index.html";
                } else if(url.indexOf("http://err.egloos.com/") >= 0 ) {
                    spcuri += "mywidget/index.html";
                }
                /*
                ...
                */
            } else if( url.indexOf("adm/post/index.html") >= 0 ) {
                spcuri += "post/index.html";
                if(url.indexOf("http://err.egloos.com/") >= 0) {
                    spcuri += "chgpcmt";
                } 
            } else if(url.indexOf("adm/openapi/index.html") >= 0) {
                spcuri += "openapi/index.html";
                if(url.indexOf("http://err.egloos.com/") >= 0 ) {
                    spcuri += "admin_apps";
                }
            } else if(url.indexOf("adm/sns/index.html") >= 0) {
                spcuri += "sns/index.html";
                if(url.indexOf("http://err.egloos.com/") >= 0) {
                    spcuri += "sns_config";
                }
            } else if(url.indexOf("http://err.egloos.com/") >= 0) {
                ...
                spcuri += "basic/chgegloo/index.html";
            } else {
			...
			spcuri = "recent/index.html";
		} else if ( url.indexOf("/popular") >= 0 ) {
			spcuri = "popular/index.html";
        } else if ( url.indexOf("egloo/index.html") >= 0 ) {
			spcuri = "egloo/index.html";
			if ( url.indexOf("http://err.egloos.com/") >= 0 ) spcuri += "post/index.html";
		} else if ( url.indexOf("photo/index.html") >= 0 ) {
			spcuri = "egloo/index.html";
			if ( url.indexOf("http://err.egloos.com/") >= 0 )	spcuri += "photo/index.html";
		}
	}
	else if ( host == "valley" ) {
		spchost = "valley";
		if ( url.indexOf("http://err.egloos.com/") >= 0  || url.indexOf("/garden") >= 0 )	spcuri = "garden/index.html";
		else if ( url.indexOf("/theme") >= 0 )	spcuri = "theme/index.html";
		else if ( url.indexOf("/trackback") >= 0 )	spcuri = "trackback/index.html";
		else if ( url.indexOf("/tag") >= 0 )	spcuri = "tag/index.html";
		else if ( url.indexOf("/review") >= 0 )	spcuri = "review/index.html";
		else if ( url.indexOf("/lifelog") >= 0 )	spcuri = "lifelog/index.html";
		else if ( url.indexOf("http://err.egloos.com/") >= 0 || url.indexOf("frm/index.html") >= 0 || url.indexOf("/my") >= 0 )	spcuri = "my/index.html";
	}
	else if ( host == "garden" ) { spchost = "garden"; }
	else if ( host == "finder" ) {
		spchost = "finder"
		if ( url.indexOf("http://err.egloos.com/") >= 0 )	spcuri = "per/index.html";
	}
	else {
		spchost = "egloo";
		if ( url.indexOf("/photo") >= 0 )	{ spcuri = "photo/index.html"; }
		else if ( url.indexOf("/garden") >= 0 )	spcuri = "garden/index.html";
		else if ( url.indexOf("/lifelog") >= 0 )	spcuri = "lifelog/index.html";
	}
	// ndr cookie set
	//setndr();
	...
	out += ("	 | <a href=\"http://www.egloos.com/rules/privacy.php\"><strong>개인정보취급방침</strong></a>");
...
function ap_copyright_gd()
{
	...
	if ( host == "www" ) {
		...
		if ( url.indexOf("/login") >= 0 ) {
			...
			spcuri = "admin/index.html";
			if ( url.indexOf("adm/photo/index.html") >= 0 ) spcuri += "photo/index.html";
			else if ( url.indexOf("adm/stat/index.html") >= 0 )	spcuri += "stat/index.html";
		} else if ( url.indexOf("egloo/index.html") >= 0 ) {
			spcuri = "egloo/index.html";
			if ( url.indexOf("http://err.egloos.com/") >= 0 ) spcuri += "post/index.html";
		} else if ( url.indexOf("photo/index.html") >= 0 ) {
...
function ap_gardenmain(uid,nid,rtnurl)
{
	...
	if ( uid == "" )
		out += (" | <a href=\"http://sec.egloos.com/login.php?returnurl=" + rtnurl + "\">로그인</a>");
	else
		out += (" | <a href=\"http://sec.egloos.com/logout.php\">로그아웃</a>");
    document.writeln( out );
}
...
function ap_topnav(uid, nid, rtnurl, opt)
{
	...
	if ( uid == "" )
		out += ("			<a href=\"http://sec.egloos.com/login.php?returnurl=" + rtnurl + "\" class=\"login\"> 로그인 </a>");
	else
		out += ("			<a href=\"http://sec.egloos.com/logout.php\" class=\"logout\"> 로그아웃 </a>");
	out += ("		</div>");
...
function ap_trackbacktitle(nid,opt)
{
	var out = "";
	var topimg = "";
	if ( opt == "1" ) post_img = "../md.egloos.com/img/eg/postleft.gif";
	else post_img = "../md.egloos.com/img/eg/updateleft.gif";
...
function ap_maintitle(uid)
{
	...
	if( uid == "" )
		out += ("<A CLASS=BK HREF=http://sec.egloos.com/login.php><B>☞로그인</B></A>&nbsp;&nbsp;");
	else
		out += ("<A CLASS=BK HREF=http://sec.egloos.com/logout.php><B>☞로그아웃</B></A>&nbsp;&nbsp;");
    document.writeln( out );
}
...
function ap_valleytop(uid,nid,rtnurl,knd)
{
	...
	if ( uid != "" )
		...
		out += ("	<AREA SHAPE=rect COORDS=\"323,1,441,23\"http://err.egloos.com/");
	out += ("	</MAP>");
	...
	if ( uid != "" ) {
		...
		out += ("	<A CLASS=SUB HREF=http://sec.egloos.com/logout.php><IMG SRC=http://md.egloos.com/img/vl/ico_logout_sub.gif BORDER=0> <B>로그아웃</B></A>&nbsp;&nbsp;");
	}
	else {
		out += ("	<A CLASS=SUB HREF=http://www.egloos.com/support.php>고객센터</A> &nbsp;|&nbsp;");
		out += ("	<A CLASS=SUB HREF=http://sec.egloos.com/login.php?returnurl=" + rtnurl + "><IMG SRC=http://md.egloos.com/img/hm/ico_login_sub.gif BORDER=0> <B>로그인</B></A>&nbsp;&nbsp;");
	}
	out += ("	</TD>");
...
function ap_subtitle(uid,nxturl)
{
	...
	out += ("	<A CLASS=BK HREF=http://www.egloos.com/support.php>고객센터</A> &nbsp;&nbsp;");
	if( uid == "" )
		out += ("<A CLASS=BK HREF=http://sec.egloos.com/login.php?returnurl=" + nxturl + "><B>☞로그인</B></A>&nbsp;&nbsp;");
	else
		out += ("<A CLASS=BK HREF=http://sec.egloos.com/logout.php><B>☞로그아웃</B></A>&nbsp;&nbsp;");
	out += ("	</TD></TR>");
	out += ("</TABLE>");
