...
function setAlbum() {
	...
	this.tmpspanid	 = null;
	this.taglistid	 = null;
	this.loading = "../../md.egloos.com/img/x.gif";
}
...
setAlbum.prototype.orgPhotoView = function () {
	ap_openwin("../photolog/photo_orga16a.html?eid=" + this.eid + "&srl=" + this.albumserial + "&fsrl=" + this.imageserial , "photologview", 520, 600, 3, true, true, true);
}
...
setAlbum.prototype.sendAlbum = function () {
    ap_openwin("../photolog/send_album_ppa16a.html?eid=" + this.eid + "&srl=" + this.albumserial, "tagapply", 520, 760, 3, false, true, false);
}

setAlbum.prototype.sendPhoto = function () {
	ap_openwin("../photolog/send_photo_ppa16a.html?eid=" + this.eid + "&srl=" + this.albumserial + "&filesrl=" + this.imageserial + "&subject=" + encodeURI(this.albumtitle), "tagapply", 520, 600, 3, false, true, false);
}
